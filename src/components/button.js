...
class Button extends React.Component {
  render() {
    ...
    switch (this.props.bstyle) {
      ...
      case "secondaryDisabled": return <button className={`${buttonStyle} ${secondaryDisabledStyle} ${styles.secondaryDisabledButton}`} type={_type}> {this.props.children} </button>;
